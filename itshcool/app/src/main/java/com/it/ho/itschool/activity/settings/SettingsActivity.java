package com.it.ho.itschool.activity.settings;
...
import com.it.ho.itschool.activity.main.Ya;
import com.it.ho.itschool.activity.main.imgur;
import com.it.ho.itschool.activity.notice.NoticeActivity;
import com.it.ho.itschool.autoupdate.updateAlarm;
/**
...
public class SettingsActivity extends AppCompatActivity {
    ...
    public static class PrefsFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            setOnPreferenceClick(findPreference("Ya"));
        ...
        private Preference.OnPreferenceClickListener onPreferenceClickListener = new Preference.OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
               ...
               else if ("Ya".equals(getKey)) {
                    AlertDialog.Builder builder = new AlertDialog.Builder(getActivity(), R.style.AppCompatAlertDialogStyle);
                    builder.setTitle("???????");
                    final EditText input2 = new EditText(getActivity());
                    builder.setView(input2);
                    builder.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int whichBufftton) {
                            String value2 = input2.getText().toString();
                            if  (value2.equals("forguseok")){
                                startActivity(new Intent(getActivity(), Ya.class));
                            }
                        }
                    });
...
//                    builder.setMessage(R.string.no_network_msg);
                    ...
                    final String ds = "f872045654038d58";
                    builder.setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int whichButton) {
                            String value = input.getText().toString();
                            String value1 = (Settings.Secure.getString(getActivity().getContentResolver(), Settings.Secure.ANDROID_ID));
                            if (value1.equals(ds)) {
        ...
        private Preference.OnPreferenceChangeListener onPreferenceChangeListener = new Preference.OnPreferenceChangeListener() {
            ...
            public boolean onPreferenceChange(Preference preference, Object newValue) {
                ...
                if (preference instanceof EditTextPreference) {
                    ...
                    com.it.ho.itschool.tool.Preference mPref = new com.it.ho.itschool.tool.Preference(getActivity());

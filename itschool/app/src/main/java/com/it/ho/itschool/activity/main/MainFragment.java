package com.it.ho.itschool.activity.main;
...
import com.it.ho.itschool.R;
import com.it.ho.itschool.School.School_Main;
import com.it.ho.itschool.activity.bap.BapActivity;
import com.it.ho.itschool.activity.exam.ExamTimeActivity;
import com.it.ho.itschool.activity.notice.NoticeActivity;
import com.it.ho.itschool.activity.timetable.TimeTableActivity;
import com.it.ho.itschool.tool.BapTool;
import com.it.ho.itschool.tool.Preference;
import com.it.ho.itschool.tool.RecyclerItemClickListener;
import com.it.ho.itschool.tool.TimeTableTool;

/**
 * Created by ho on 2016-8-25.
 */
                ...
                if (isSimple) {
                    ...
                    switch (position) {
                        case 0:
                            ...
                            break;
                        case 1:
                            Toast.makeText(getActivity(), "2017년 일정 준비중..", Toast.LENGTH_SHORT).show();
//                            startActivity(new Intent(getActivity(), ScheduleActivity.class));
        ...
        if (code == 1) {
            ...
            mAdapter.addItem(R.drawable.icon2,
                    getString(R.string.title_activity_exam_range),
                    getString(R.string.message_activity_exam_range));
            mAdapter.addItem(R.drawable.icon,
                    getString(R.string.sinfo),
                    getString(R.string.ssinfo));
        }

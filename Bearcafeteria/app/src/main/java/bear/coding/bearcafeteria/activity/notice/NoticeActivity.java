package bear.coding.bearcafeteria.activity.notice;
        ...
        if (Tools.isOnline(getApplicationContext())) {
            if (Tools.isWifi(getApplicationContext()) || forceUpdate) {
                getNoticeDownloadTask mTask = new getNoticeDownloadTask();
                    mTask.execute("https://docs.google.com/spreadsheets/d/e/2PACX-1vQ1S840MIfm0CZEJ36pseQpEdPBurr1Kw6ReUIvzKyR6dcoFK91dd8WjU4_JHpx_mxkTrtUH--w-g67/pubhtml?gid=0&single=true");
            } else {

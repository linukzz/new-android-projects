package bear.coding.bearcafeteria.activity.exam;
...
import bear.coding.bearcafeteria.tool.ExamTimeTool;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if ((mGrade != -1) && (mType != -1)) {
            if (fileExists) {
                ...
                mToolbar.setTitle(String.format(getString(R.string.exam_time_title), mGrade, (mType == 0 ? "전자통신과" : "웹디자인과"), mData.date, mData.type));
            }
        }

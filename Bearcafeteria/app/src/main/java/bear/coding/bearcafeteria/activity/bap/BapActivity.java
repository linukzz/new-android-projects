package bear.coding.bearcafeteria.activity.bap;
...
import bear.coding.bearcafeteria.activity.bap.star.BapStarActivity;
import bear.coding.bearcafeteria.tool.BapTool;
import bear.coding.bearcafeteria.tool.Preference;
import bear.coding.bearcafeteria.tool.ProcessTask;
...
public class BapActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mListView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> adapterView, View view, int position, long id) {
               ...
               String mShareBapMsg;
                mShareBapMsg = String.format(getString(R.string.shareBap_message_msg), mData.mCalender, mData.mLunch, mData.mDinner);
    ...
    public void setCalenderBap() {
        ...
        datePickerDialog.setYearRange(2017 , 2050);

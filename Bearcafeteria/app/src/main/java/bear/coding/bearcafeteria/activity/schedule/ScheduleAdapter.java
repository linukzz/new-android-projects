package bear.coding.bearcafeteria.activity.schedule;
...
//        mView.setBackgroundResource(mBackground);
    ...
    public void onBindViewHolder(final ScheduleViewHolder holder, int position) {
        ...
        if (mInfo.isHoliday) {
            ...
            holder.mDate.setTextColor(ContextCompat.getColor(holder.mDate.getContext(),

package bear.coding.bearcafeteria.activity.bap.star;
...
import bear.coding.bearcafeteria.tool.Database;
import bear.coding.bearcafeteria.tool.HiddenCode;
import bear.coding.bearcafeteria.tool.Preference;
import bear.coding.bearcafeteria.tool.TimeTableTool;
import bear.coding.bearcafeteria.tool.Tools;
...
//            mDinnerListView.setAdapter(mDinnerAdapter);
    ...
    private class HttpTask extends AsyncTask<String, Void, Integer> {
        ...
        protected Integer doInBackground(String... params) {
            try {
                HttpPost postRequest = new HttpPost("https://script.google.com/macros/s/AKfycbxP4DWek47flCO0pIW8_V6ckF5pXKRxvIKXKIejGT3Lb57e7nX5/exec");
...
//                nameValue.add(new BasicNameValuePair("memo", params[2]));
                nameValue.add(new BasicNameValuePair("deviceId",
    ...
    private void showRiceStar() {
        if (Tools.isOnline(getApplicationContext())) {
            if (Tools.isWifi(getApplicationContext())) {
                ...
                mTask.execute("https://docs.google.com/spreadsheets/d/e/2PACX-1vQ1S840MIfm0CZEJ36pseQpEdPBurr1Kw6ReUIvzKyR6dcoFK91dd8WjU4_JHpx_mxkTrtUH--w-g67/pubhtml?gid=989931015&single=true");
            } else {

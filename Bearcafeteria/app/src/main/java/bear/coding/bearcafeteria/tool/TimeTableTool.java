package bear.coding.bearcafeteria.tool;
...
public class TimeTableTool {
    public static final String TimeTableDBName = "itSchoolTimeTable.db";
    public static final String tableName = "itTimeTable";
    public final static String mFilePath = "/data/data/com.it.ho.itschool/databases/";
    public final static String mGoogleSpreadSheetUrl = "https://docs.google.com/spreadsheets/d/e/2PACX-1vQ1S840MIfm0CZEJ36pseQpEdPBurr1Kw6ReUIvzKyR6dcoFK91dd8WjU4_JHpx_mxkTrtUH--w-g67/pubhtml?gid=1612100176&single=true";
